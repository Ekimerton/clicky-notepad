...
const Textarea = forwardRef(
  ({ className, ignoreMute = false, ...props }, ref) => {
    ...
    return (
      <textarea
        ref={ref}
        className={`p-4 bg-white dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-hidden focus:ring focus:ring-slate-200 dark:focus:ring-neutral-600 ${
          className || ""
        }`}
